        ...
        <div className="fondo_rojo">
            <div className="row pt-5">
                ...
                <div className=" col-md-3">
                    <h3 className="text-light">Descargá la APP y disfrutá mucho más por mucho menos</h3>
                    <p className="text-light">Apple y el logotipo de Apple son marcas comerciales de Apple Inc., registradas en EE. UU.
